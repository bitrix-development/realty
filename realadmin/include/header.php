<header class="page-header row">
        <div class="logo-wrapper d-flex align-items-center col-auto" style="background-color: #ffffff;"><a href="/"><img class="light-logo img-fluid" src="../assets/images/logo/logo2.png" alt="logo"><img class="dark-logo img-fluid" src="../assets/images/logo/logo2.png" alt="logo"></a><a class="close-btn toggle-sidebar" href="javascript:void(0)">
                ...
                <div class="custom-menu overflow-hidden">
                  <ul class="profile-body">
                    <li class="d-flex"> 
                      ...
                      </svg><a class="ms-2" href="user-profile.html">Профиль</a>
                    </li>
                  
                    <li class="d-flex"> 
                      <svg class="svg-color">
                        <use href="../assets/svg/iconly-sprite.svg#Login"></use>
                      </svg><a class="ms-2" href="logout.php">Выйти</a>
                    </li>
                  </ul>
                </div>
              </li>
