...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    (name, description, min_price, prices, commission, developer, completion_date, curator, curator_phone, address, coordinates, location, object_type, files, download, video, ak, tags, main_photo, publication_status, publication_date)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?, ?, ?)";
    ...
    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param(
            ...
            $curator, $curator_phone, $address, $coordinates, $location,
            $object_type, $files, $download, $video, $ak, $tags, $main_photo, $publication_status, $publication_date
        );
        if ($stmt->execute()) {
...
<body>
                ...
                <div class="row g-xl-5 g-3">
                    ...
                    <div class="tab-content" id="add-product-pills-tabContent">
                        ...
                        <div class="sidebar-body">
                            ...
                            <input type="hidden" name="main_photo" id="main_photo_input" value="">
                        ...
                        <div class="sidebar-body">
                            ...
                            <div class="row g-3 custom-input">
                                ...
                                <input class="form-control" id="initialCost" name="initialCost" type="text">
                                </div>
                                <div class="col-sm-6">
  ...
  <div class="row custom-input">
    ...
    <!-- отключаем автоинициализацию Dropzone ДО подключения Dropzone.js -->
    <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var dz = new Dropzone("#mainPhotoDropzone", {
            url: "/realadmin/upload.php", // Ваш обработчик загрузки
