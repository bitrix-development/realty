...
<html lang="en">
  ...
  <body>
    ...
    <?php
   require '../realadmin/include/header.php';
   ?>  <!-- Page Body Start-->
   <div class="page-body-wrapper"> 
   <?php
   require '../realadmin/include/sidebar.php';
   ?>
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <?php
   require '../realadmin/include/breadcrumbs.php';
   ?>        
              </div>
            </div>
          </div>
        ...
        <?php
   require '../realadmin/include/footer.php';
   ?>   
      </div>
    </div>
    </div>
