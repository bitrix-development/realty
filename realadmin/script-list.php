              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Скрипты продаж </li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  <div class="row">
                    ...
                    <div class="col-md-6 d-md-block d-none">
                      <div class="form-group mb-0 me-0"> </div><a class="btn btn-primary d-flex align-items-center" href="/realadmin/script-create.php"> <i data-feather="plus-square"></i>Добавить скрипт </a>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                        <div class="row">
                          <div class="col-xxl-4 col-md-6">
                            <div class="project-box font-dark bg-light-danger"><span class="badge badge-danger">Не опубликован</span>
                              <h5 class="f-w-500 mb-2 text-danger">Заголовок скрипта</h5>
                              ...
                              <div class="project-status mt-4">
                                <div class="d-flex align-items-center gap-1 mb-2">
                                  <p class="mb-0">70% </p><span>Опубликован</span>
                                </div>
                          ...
                          <div class="col-xxl-4 col-md-6">
                            <div class="project-box font-dark bg-light-success"><span class="badge badge-success">Опубликован</span>
                              <h5 class="f-w-500 mb-2 text-success">Заголовок скрипта</h5>
                              ...
                              <div class="project-status mt-4">
                                <div class="d-flex align-items-center gap-1 mb-2">
                                  <p class="mb-0">100% </p><span>Опубликован</span>
                                </div>
