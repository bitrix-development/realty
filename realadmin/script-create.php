              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  ...
                  <li class="breadcrumb-item"><a href="/realadmin/"><i class="iconly-Home icli svg-color"></i></a></li>   
                    <li class="breadcrumb-item active">Добавить скрипт</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    <div class="form theme-form basic-form">
                      <div class="row">
                        <div class="col"> 
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Заголовок </h5>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Обращение</h5>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Тип сделки</h5>
                        ...
                        <div class="col-sm-4">
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Объем сделки </h5>
                            <select class="form-select">
                              <option>до 1 млн</option>
                              <option> от 1 - 5 млн</option>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Описание скрипта</h5>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            <h5 class="f-w-600 mb-2">Файлы в помощь</h5>
